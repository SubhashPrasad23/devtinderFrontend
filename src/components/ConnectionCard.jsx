  ...
  return (
    ...
    >
      <div className="flex items-center">
       ...
       { connection?.photoURL && connection?.photoURL !==""?<img src={connection?.photoURL} className="h-full w-full object-cover rounded-full" alt="profile"/> : <span className="text-xl font-bold text-white/70">
