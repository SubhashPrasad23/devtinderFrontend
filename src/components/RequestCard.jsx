...
const RequestCard = ({request,onClick}) => {
  ...
  >
      ...
      {request?.fromUserId.photoURL && request?.fromUserId.photoURL !==""?<img src={request.fromUserId.photoURL} className="h-full w-full object-cover" alt="profile"/>  :<span className="text-xl font-bold text-white/70">
          {capitalized(
